...
class ProfessorsCubeRandomScrambler(scramblerInfo: ScramblerInfo, scrambleLength: Int) : BigCubeRandomScrambler(scramblerInfo, scrambleLength) {
    override val dimension: Int
        get() = 5
    override val moves: Array<Array<String>>
        get() = arrayOf(arrayOf("U", "U2", "U'"), arrayOf("Uw", "Uw2", "Uw'"), arrayOf("Dw", "Dw2", "Dw'"), arrayOf("D", "D2", "D'"), arrayOf("L", "L2", "L'"), arrayOf("Lw", "Lw2", "Lw'"), arrayOf("Rw", "Rw2", "Rw'"), arrayOf("R", "R2", "R'"), arrayOf("F", "F2", "F'"), arrayOf("Fw", "Fw2", "Fw'"), arrayOf("Bw", "Bw2", "Bw'"), arrayOf("B", "B2", "B'"))
}