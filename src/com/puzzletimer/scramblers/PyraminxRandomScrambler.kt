...
class PyraminxRandomScrambler(override val scramblerInfo: ScramblerInfo, minScrambleLength: Int) : Scrambler {
    private val solver: PyraminxSolver
    ...
    init {
        solver = PyraminxSolver(minScrambleLength)
        random = Random()
    }
}