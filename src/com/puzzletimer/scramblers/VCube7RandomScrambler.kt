...
class VCube7RandomScrambler(scramblerInfo: ScramblerInfo, scrambleLength: Int) : BigCubeRandomScrambler(scramblerInfo, scrambleLength) {
    override val dimension: Int
        get() = 7
    override val moves: Array<Array<String>>
        get() = arrayOf(arrayOf("U", "U2", "U'"), arrayOf("2U", "2U2", "2U'"), arrayOf("3U", "3U2", "3U'"), arrayOf("3D", "3D2", "3D'"), arrayOf("2D", "2D2", "2D'"), arrayOf("D", "D2", "D'"), arrayOf("L", "L2", "L'"), arrayOf("2L", "2L2", "2L'"), arrayOf("3L", "3L2", "3L'"), arrayOf("3R", "3R2", "3R'"), arrayOf("2R", "2R2", "2R'"), arrayOf("R", "R2", "R'"), arrayOf("F", "F2", "F'"), arrayOf("2F", "2F2", "2F'"), arrayOf("3F", "3F2", "3F'"), arrayOf("3B", "3B2", "3B'"), arrayOf("2B", "2B2", "2B'"), arrayOf("B", "B2", "B'"))
}