...
class Square1CubeShapeScrambler(override val scramblerInfo: ScramblerInfo) : Scrambler {
    private val solver: Square1Solver
    private val random: Random
    override val nextScramble: Scramble
        get() = Scramble(
                scramblerInfo.scramblerId,
                solver.generate(
                        solver.getRandomState(Square1Solver.State.id, random)))
