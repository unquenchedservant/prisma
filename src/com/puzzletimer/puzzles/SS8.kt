...
class SS8 : Puzzle {
    ...
    override fun getScrambledPuzzleMesh(colorScheme: ColorScheme, sequence: Array<String>): Mesh? {
        ...
        val planeL = Plane(Vector3(-0.3750, 0, 0), Vector3(-1, 0, 0))
        val planeL2 = Plane(Vector3(-0.2500, 0, 0), Vector3(-1, 0, 0))
        val planeL3 = Plane(Vector3(-0.1250, 0, 0), Vector3(-1, 0, 0))
        val planeL4 = Plane(Vector3(-0.0000, 0, 0), Vector3(-1, 0, 0))
        val planeR4 = Plane(Vector3(0.0000, 0, 0), Vector3(1, 0, 0))
        val planeR3 = Plane(Vector3(0.1250, 0, 0), Vector3(1, 0, 0))
        val planeR2 = Plane(Vector3(0.2500, 0, 0), Vector3(1, 0, 0))
        val planeR = Plane(Vector3(0.3750, 0, 0), Vector3(1, 0, 0))
        val planeD = Plane(Vector3(0, -0.3750, 0), Vector3(0, -1, 0))
        val planeD2 = Plane(Vector3(0, -0.2500, 0), Vector3(0, -1, 0))
        val planeD3 = Plane(Vector3(0, -0.1250, 0), Vector3(0, -1, 0))
        val planeD4 = Plane(Vector3(0, -0.0000, 0), Vector3(0, -1, 0))
        val planeU4 = Plane(Vector3(0, 0.0000, 0), Vector3(0, 1, 0))
        val planeU3 = Plane(Vector3(0, 0.1250, 0), Vector3(0, 1, 0))
        val planeU2 = Plane(Vector3(0, 0.2500, 0), Vector3(0, 1, 0))
        val planeU = Plane(Vector3(0, 0.3750, 0), Vector3(0, 1, 0))
        val planeF = Plane(Vector3(0, 0, -0.3750), Vector3(0, 0, -1))
        val planeF2 = Plane(Vector3(0, 0, -0.2500), Vector3(0, 0, -1))
        val planeF3 = Plane(Vector3(0, 0, -0.1250), Vector3(0, 0, -1))
        val planeF4 = Plane(Vector3(0, 0, -0.0000), Vector3(0, 0, -1))
        val planeB4 = Plane(Vector3(0, 0, 0.0000), Vector3(0, 0, 1))
        val planeB3 = Plane(Vector3(0, 0, 0.1250), Vector3(0, 0, 1))
        val planeB2 = Plane(Vector3(0, 0, 0.2500), Vector3(0, 0, 1))
        val planeB = Plane(Vector3(0, 0, 0.3750), Vector3(0, 0, 1))
        mesh = mesh
                .cut(planeL, 0.0)
                .cut(planeL2, 0.0)
                .cut(planeL3, 0.0)
