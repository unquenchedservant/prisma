...
class FloppyCube : Puzzle {
    override val puzzleInfo: PuzzleInfo
        get() = PuzzleInfo("FLOPPY-CUBE")
    ...
    override fun getScrambledPuzzleMesh(colorScheme: ColorScheme, sequence: Array<String>): Mesh? {
        ...
        var mesh = Mesh.cube(colorArray)
                .transform(
                        Matrix44(arrayOf(doubleArrayOf(1.0, 0.0, 0.0, 0.0), doubleArrayOf(0.0, 1.0, 0.0, 0.0), doubleArrayOf(0.0, 0.0, 1.0 / 3, 0.0), doubleArrayOf(0.0, 0.0, 0.0, 1.0))))
        ...
        twists["D"] = Twist(planeD, Math.PI)
        twists["U"] = Twist(planeU, Math.PI)
        ...
        return mesh
                .transform(
                        Matrix44(arrayOf(doubleArrayOf(1.25, 0.0, 0.0, 0.0), doubleArrayOf(0.0, 1.25, 0.0, 0.0), doubleArrayOf(0.0, 0.0, 1.25, 0.0), doubleArrayOf(0.0, 0.0, 0.0, 1.0))))
