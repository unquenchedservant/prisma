...
class RubiksTower : Puzzle {
    override val puzzleInfo: PuzzleInfo
        get() = PuzzleInfo("RUBIKS-TOWER")
    ...
    override fun getScrambledPuzzleMesh(colorScheme: ColorScheme, sequence: Array<String>): Mesh? {
        ...
        var mesh = Mesh.cube(colorArray)
                .transform(
                        Matrix44(arrayOf(doubleArrayOf(1.0 / 2, 0.0, 0.0, 0.0), doubleArrayOf(0.0, 1.0, 0.0, 0.0), doubleArrayOf(0.0, 0.0, 1.0 / 2, 0.0), doubleArrayOf(0.0, 0.0, 0.0, 1.0))))
        ...
        return mesh
                .transform(
                        Matrix44(arrayOf(doubleArrayOf(1.4, 0.0, 0.0, 0.0), doubleArrayOf(0.0, 1.4, 0.0, 0.0), doubleArrayOf(0.0, 0.0, 1.4, 0.0), doubleArrayOf(0.0, 0.0, 0.0, 1.0))))
