...
class VCube7 : Puzzle {
    ...
    override fun getScrambledPuzzleMesh(colorScheme: ColorScheme, sequence: Array<String>): Mesh? {
        ...
        val planeL = Plane(Vector3(-0.335, 0, 0), Vector3(-1, 0, 0))
        val planeL2 = Plane(Vector3(-0.200, 0, 0), Vector3(-1, 0, 0))
        val planeL3 = Plane(Vector3(-0.065, 0, 0), Vector3(-1, 0, 0))
        val planeR3 = Plane(Vector3(0.065, 0, 0), Vector3(1, 0, 0))
        val planeR2 = Plane(Vector3(0.200, 0, 0), Vector3(1, 0, 0))
        val planeR = Plane(Vector3(0.335, 0, 0), Vector3(1, 0, 0))
        val planeD = Plane(Vector3(0, -0.335, 0), Vector3(0, -1, 0))
        val planeD2 = Plane(Vector3(0, -0.200, 0), Vector3(0, -1, 0))
        val planeD3 = Plane(Vector3(0, -0.065, 0), Vector3(0, -1, 0))
        val planeU3 = Plane(Vector3(0, 0.065, 0), Vector3(0, 1, 0))
        val planeU2 = Plane(Vector3(0, 0.200, 0), Vector3(0, 1, 0))
        val planeU = Plane(Vector3(0, 0.335, 0), Vector3(0, 1, 0))
        val planeF = Plane(Vector3(0, 0, -0.335), Vector3(0, 0, -1))
        val planeF2 = Plane(Vector3(0, 0, -0.200), Vector3(0, 0, -1))
        val planeF3 = Plane(Vector3(0, 0, -0.065), Vector3(0, 0, -1))
        val planeB3 = Plane(Vector3(0, 0, 0.065), Vector3(0, 0, 1))
        val planeB2 = Plane(Vector3(0, 0, 0.200), Vector3(0, 0, 1))
        val planeB = Plane(Vector3(0, 0, 0.335), Vector3(0, 0, 1))
        mesh = mesh
                .cut(planeL, 0.0)
                .cut(planeL2, 0.0)
                .cut(planeL3, 0.0)
