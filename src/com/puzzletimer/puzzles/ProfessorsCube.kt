...
class ProfessorsCube : Puzzle {
    override val puzzleInfo: PuzzleInfo
        get() = PuzzleInfo("5x5x5-CUBE")
    ...
    override fun getScrambledPuzzleMesh(colorScheme: ColorScheme, sequence: Array<String>): Mesh? {
        ...
        val planeL = Plane(Vector3(-0.3, 0, 0), Vector3(-1, 0, 0))
        val planeLw = Plane(Vector3(-0.1, 0, 0), Vector3(-1, 0, 0))
        val planeR = Plane(Vector3(0.3, 0, 0), Vector3(1, 0, 0))
        val planeRw = Plane(Vector3(0.1, 0, 0), Vector3(1, 0, 0))
        val planeD = Plane(Vector3(0, -0.3, 0), Vector3(0, -1, 0))
        val planeDw = Plane(Vector3(0, -0.1, 0), Vector3(0, -1, 0))
        val planeU = Plane(Vector3(0, 0.3, 0), Vector3(0, 1, 0))
        val planeUw = Plane(Vector3(0, 0.1, 0), Vector3(0, 1, 0))
        val planeF = Plane(Vector3(0, 0, -0.3), Vector3(0, 0, -1))
        val planeFw = Plane(Vector3(0, 0, -0.1), Vector3(0, 0, -1))
        val planeB = Plane(Vector3(0, 0, 0.3), Vector3(0, 0, 1))
        val planeBw = Plane(Vector3(0, 0, 0.1), Vector3(0, 0, 1))
        mesh = mesh
                .cut(planeL, 0.0)
                .cut(planeR, 0.0)
                .cut(planeLw, 0.0)
