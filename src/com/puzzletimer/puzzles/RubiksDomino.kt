...
class RubiksDomino : Puzzle {
    override val puzzleInfo: PuzzleInfo
        get() = PuzzleInfo("RUBIKS-DOMINO")
    ...
    override fun getScrambledPuzzleMesh(colorScheme: ColorScheme, sequence: Array<String>): Mesh? {
        ...
        var mesh = Mesh.cube(colorArray)
                .transform(
                        Matrix44(arrayOf(doubleArrayOf(1.0, 0.0, 0.0, 0.0), doubleArrayOf(0.0, 2.0 / 3, 0.0, 0.0), doubleArrayOf(0.0, 0.0, 1.0, 0.0), doubleArrayOf(0.0, 0.0, 0.0, 1.0))))
        val planeL = Plane(Vector3(-0.166, 0, 0), Vector3(-1, 0, 0))
        val planeR = Plane(Vector3(0.166, 0, 0), Vector3(1, 0, 0))
        val planeD = Plane(Vector3(0, 0, 0), Vector3(0, -1, 0))
        val planeU = Plane(Vector3(0, 0, 0), Vector3(0, 1, 0))
        ...
        return mesh
                .transform(
                        Matrix44(arrayOf(doubleArrayOf(1.1, 0.0, 0.0, 0.0), doubleArrayOf(0.0, 1.1, 0.0, 0.0), doubleArrayOf(0.0, 0.0, 1.1, 0.0), doubleArrayOf(0.0, 0.0, 0.0, 1.0))))
