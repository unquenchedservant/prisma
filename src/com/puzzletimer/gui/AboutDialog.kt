...
class AboutDialog(owner: JFrame?, modal: Boolean) : JDialog(owner, modal) {
    private fun createComponents() {
        layout = MigLayout("", "", "")

        // panel3D
        val puzzle: Puzzle = RubiksCube()
        val colorScheme = ColorScheme(
                "RUBIKS-CUBE", arrayOf(
                FaceColor("RUBIKS-CUBE", "FACE-B", null, Color(255, 255, 255)),
                FaceColor("RUBIKS-CUBE", "FACE-D", null, Color(255, 255, 255)),
                FaceColor("RUBIKS-CUBE", "FACE-F", null, Color(255, 255, 255)),
                FaceColor("RUBIKS-CUBE", "FACE-L", null, Color(255, 255, 255)),
                FaceColor("RUBIKS-CUBE", "FACE-R", null, Color(255, 255, 255)),
                FaceColor("RUBIKS-CUBE", "FACE-U", null, Color(255, 255, 255))))
        val panel3D = Panel3D()
        panel3D.setCameraPosition(Vector3(0, 0, -4.5))
        ...
        val labelPrismaPuzzleTimer = JLabel(_("about.prisma_puzzle_timer").toString() + " " + _("about.version"))
        labelPrismaPuzzleTimer.font = Font("Arial", Font.BOLD, 16)
        add(labelPrismaPuzzleTimer, "split 3, gapbottom 10, flowy")

        // labelWalter
        val labelContributors = JLabel(_("about.contributors"))
        add(labelContributors)
    }

    init {
        title = _("about.prisma_puzzle_timer").toString() + " " + _("about.version")
        isResizable = false
        createComponents()
        pack()
    }
